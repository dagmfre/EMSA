const achievementsInfo = {
  scorp: [
    {
      title: "ለወገኖቻችን እጃችን እንዘርጋ PROJECT",
      description:
        "Due to the current situation of our country, many people are forced to leave their homes and settle at a camp in Debrebrhan. There are about 7000 to 16000 people at a Single camp. As follows, we were able to collect and donate clothes, shoes, sanitary pads and face masks from medical students at different campuses.",
    },
    {
      title: "PROJECT ASKWALA",
      description:
        "In collaboration with Memhr Weldemariyam Charity Association, we have collected and donated books to Mehal Amba primary school found in the rural area of Debrebirhan. Any books from fictions to school books are being collected.",
    },
    {
      title: "HOT ISSUE",
      description:
        "We believe every child deserve to be happy. Last Christmas, we gave toys and clothes to children living on the streets of Addis.",
    },
    {
      title: "PROJECT WECARE",
      description:
        "Weekly training that lasted for 4 weeks and was given at Mekanisa Deaf School. We trained the students on Sexual and reproductive health, Addiction and Advocacy.",
    },
    {
      title: "LEARNING DISABILITY PROJECT",
      description:
        "Our Learning Disability Awareness Project collaborated with FANA Ethiopia to train and certify over 70 health professionals. Through an awareness training session, we equipped participants with essential knowledge on diagnosing and treating learning disabilities. Additionally, in partnership with Yetenaweg, we conducted a podcast session to further raise awareness on this important topic. Together, we worked towards promoting inclusive care and enhancing understanding of learning disabilities among healthcare providers and the broader community.",
    },
    {
      title: "Disability Inclusive Health Care System",
      description:
        "Our project focused on promoting disability-inclusive healthcare through an online seminar. We organized a thought-provoking discussion with Zewdu Guluma, a disability mainstreaming and sign language specialist from the Ministry of Health. The session highlighted critical issues that require immediate interventions within the healthcare system. By facilitating this informative online seminar, we aimed to raise awareness and advocate for urgent actions to create a more inclusive healthcare environment for individuals with disabilities.",
    },
    {
      title: "Children's Heart Fund Ethiopia STUDENT AMBASSADORSHIP PROGRAM",
      description:
        "Children's Heart Fund Ethiopia STUDENT AMBASSADORSHIP PROGRAM",
    },
  ],
  scora: [
    {
